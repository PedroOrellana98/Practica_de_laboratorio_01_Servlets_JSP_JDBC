 ...
 * Class ContextJDBC.
 * 
 * Clase que permite obtener una conexion a la base de datos y asegura que si ya
 * existe una conexion no la vuelva a crear utilizando el patron de disenio
 * Singleton. Ademas, implementa los metodos para poder enviar sentencias SQL como
...
public class ContextJDBC {
	...
	private static final String PASS = "David1998.luis";
